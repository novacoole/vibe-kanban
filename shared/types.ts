...
export type Project = { id: string, name: string, git_repo_path: string, setup_script: string | null, dev_script: string | null, cleanup_script: string | null, copy_files: string | null, parallel_setup_script: boolean, release_ports_on_completion: boolean | null, port_range_start: bigint | null, port_range_end: bigint | null, remote_project_id: string | null, created_at: Date, updated_at: Date, };

export type CreateProject = { name: string, git_repo_path: string, use_existing_repo: boolean, setup_script: string | null, dev_script: string | null, cleanup_script: string | null, copy_files: string | null, parallel_setup_script: boolean | null, release_ports_on_completion: boolean | null, port_range_start: bigint | null, port_range_end: bigint | null, };

export type UpdateProject = { name: string | null, git_repo_path: string | null, setup_script: string | null, dev_script: string | null, cleanup_script: string | null, copy_files: string | null, parallel_setup_script: boolean | null, release_ports_on_completion: boolean | null, port_range_start: bigint | null, port_range_end: bigint | null, };
...
export type TaskAttempt = { id: string, task_id: string, container_ref: string | null, branch: string, target_branch: string, executor: string, worktree_deleted: boolean, setup_completed_at: string | null, assigned_ports: string | null, created_at: string, updated_at: string, };
